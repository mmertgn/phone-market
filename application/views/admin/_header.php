    ...
    <div class="navbar-container ace-save-state" id="navbar-container">
        ...
        <div class="navbar-header pull-left">
            <a href="<?php echo base_url(); ?>admin/home" class="navbar-brand">
                <small>
                    <?= $veri[0]->sirketadi ?> Yönetim Paneli
                </small>
            </a>
        </div>
            ...
            <ul class="nav ace-nav">
                ...
                <li class="light-blue dropdown-modal">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <img class="nav-user-photo" src="<?php echo base_url(); ?>assets/admin/images/avatars/user.jpg" alt="" />
								<span class="user-info">
									<?=$this->session->logged_in['adsoy']?>
                    ...
                    <ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                        ...
                        <li>
                            <a href="<?php echo base_url(); ?>admin/kullanicilar/edit/<?=$this->session->logged_in['id']?>">
