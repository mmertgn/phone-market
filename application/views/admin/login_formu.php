                ...
                <div class="login-container">
                    <div class="center">
                        <h1>
                            ...
                            <span class="red">Gülcüler İletişim Yönetim Paneli </span>
                            <span class="white" id="id-text2">Application</span>
                        </h1>
                        <h4 class="blue" id="id-company-text">&copy; Gülcüler İletişim</h4>
                    </div>
                        ...
                        <div id="forgot-box" class="forgot-box widget-box no-border">
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <div class="space-6"></div>
                                    <p>
                                       Email adresinizi giriniz ve talimatları yapınız.
                                    </p>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="clearfix">
                                                <button type="reset" class="width-30 pull-left btn btn-sm">
                                                    ...
                                                    <span class="bigger-110">Sil</span>
                                                </button>
