    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li><a href="<?=base_url()?>admin/kullanicilar/ekle"><button type="button" class="btn btn-yellow" style="margin-bottom: 6px">Kullanıcı Ekle</button></a></li>
            </ul><!-- /.breadcrumb -->
        </div>
                                ...
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dynamic-table_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="hidden-480 sorting" tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1" aria-label="Clicks: activate to sort column ascending">Yetki</th>
                                        ...
                                        <tr role="row" class="odd selected">
                                            ...
                                            <td>
                                                <div class="hidden-sm hidden-xs action-buttons">
                                                    <a class="blue" href="<?=base_url()?>admin/kullanicilar/preview/<?=$rs->id?>">
                                                        <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                    </a>
                                                    <a class="green" href="<?=base_url()?>admin/kullanicilar/edit/<?=$rs->id?>">
                                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                    </a>
                                                    <a class="red" href="<?=base_url()?>admin/kullanicilar/delete/<?=$rs->id?>">
                                                ...
                                                <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                            <li>
                                                                <a href="<?=base_url()?>admin/kullanicilar/preview/<?=$rs->id?>" class="tooltip-info" data-rel="tooltip" title="" data-original-title="Göster">
                                                                    <span class="blue">
