    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-xs-12">
                        <h3 class="header smaller lighter blue">Siparişler</h3>
                            ...
                            <div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
                                ...
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dynamic-table_info">
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="hidden-480 sorting" tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1" aria-label="Clicks: activate to sort column ascending">Tutar</th>
                                    ...
                                    foreach($siparisler as $rs) {
                                        ...
                                        <tr role="row" class="odd selected">
                                            ...
                                            <td><?= $rs->tarih ?></td>
                                            <td class="hidden-480">
                                                <span class="label label-sm label-warning"><?= $rs->siparisdurumu ?></span>
                                            </td>
                                            <td>
                                                <div class="hidden-sm hidden-xs action-buttons">
                                                    <a class="green" href="<?=base_url()?>admin/siparis/edit/<?=$rs->id?>">
                                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                    </a>
                                                    <a class="red" href="<?=base_url()?>admin/siparis/delete/<?=$rs->id?>">
                                                ...
                                                <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                            <li>
                                                                <a href="<?=base_url()?>admin/siparis/edit/<?=$rs->id?>" class="tooltip-success" data-rel="tooltip" title="" data-original-title="Düzenle">
                                                                    <span class="green">
                                                            ...
                                                            <li>
                                                                <a href="<?=base_url()?>admin/siparis/delete/<?=$rs->id?>" onclick="return confirm('Silinecek!! Emin misin?');" class="tooltip-error" data-rel="tooltip" title="" data-original-title="Sil">
                                                                    <span class="red">
