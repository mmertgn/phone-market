            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="breadcrumbs-inner">
                        <h1 class="breadcrumbs-title"><?= $katsecili[0]->kat_adi ?>
                            <br>
                            <br>
                            <p style="font-size: 24px"><?= $katsecili[0]->adi ?></p>
                        </h1>
                        <ul class="breadcrumb-list">
                            <li><a href="<?= base_url() ?>">Anasayfa</a></li>
                            <li><a href="<?= base_url() ?>kategori/liste/<?= $katsecili[0]->kat_id ?>"><?= $katsecili[0]->kat_adi ?></a></li>
                            <li><?= $katsecili[0]->adi ?></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-3 col-md-pull-9 col-sm-12">
                    ...
                    <aside class="widget-search mb-30">
                        <form action="<?= base_url() ?>home/arama" method="post">
                            <input type="text" minlength="3" name="search" placeholder="Ne aramıştınız?" required><button type="submit"><i class="zmdi zmdi-search"></i></button>
                        </form>
                    </aside>
                    <!-- widget-categories -->
                    ...
                    <aside class="widget operating-system box-shadow mb-30">
                        ...
                        foreach ($urun_altkat as $rs) {
                            if ($rs->kat_id == $katsecili[0]->kat_id && $rs->id == $katsecili[0]->id ) {
                                ?>
                                <li class="border-left"><a href="<?= base_url() ?>altkategori/liste/<?= $rs->id ?>"
                                          name="operating-1"><?= $rs->adi ?></li>
                                <?php
                            }
                            elseif($rs->kat_id == $katsecili[0]->kat_id){
                                ?>
                                <label><a href="<?= base_url() ?>altkategori/liste/<?= $rs->id ?>"
                                                           name="operating-1"><?= $rs->adi ?></label><br>
                            <?php
                            }
                        }
                        ?>
